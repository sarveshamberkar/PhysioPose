...
let state = 'waiting';
let targetLabel;
var det = ['a','b','c','b','a','d','e','d','a','done']
var og_det = ['a','b','c','b','a','d','e','d','a','done']
var to_show = ['stand','raise right hand', 'bend left','release','put right hand down', 'raise left hand' ,'bend right', 'release' ,'put left hand down',"done",]
var number_step = 8
var now_perform = 0
var flag1 = 0
var f1,f2,f3,f4 =0
