...
let state = 'waiting';
let targetLabel;
var det = ['a','b','a','c','a','done']
var og_det = ['a','b','a','c','a','done']
var to_show = ['Keep your legs apart','Bend towards right', 'Release','Bend towards left','Release',"Done!"]
var number_step = 8
var now_perform = 0
var flag1 = 0
var f1,f2,f3,f4 =0
...
const modelInfo = {
  model: 'static/model2/model.json',
  metadata: 'static/model2/model_meta.json',
  weights: 'static/model2/model.weights.bin',
};
