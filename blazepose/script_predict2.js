...
var to_show = ['Stand','Raise your right leg  slowly', 'Lower your leg now','Raise your left leg slowly','Lower your leg',"done"]
var number_step = 8
var now_perform = 0
var flag1 = 0
var f1,f2,f3,f4 =0
...
function gotResult(error, results){
  ...
  if (predicted==det[count] && det[count+1] != 'done'){
    now_perform =  'now perform '+to_show[count+1]
  }
